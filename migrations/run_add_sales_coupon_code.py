"""Aplica add_sales_coupon_code.sql de forma idempotente."""
...
def main() -> None:
    ...
    try:
        with conn.cursor() as cur:
            cur.execute("SHOW COLUMNS FROM sales LIKE 'coupon_code'")
            if cur.fetchone() is None:
                ...
                print("OK: sales.coupon_code agregada")
            else:
                print("SKIP: sales.coupon_code ya existe")
        conn.commit()
